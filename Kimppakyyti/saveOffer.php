        ...
        <main>
            ...
            <section>
                <div class="form-style-6">
                    <br><br><br>
                    <h1>Tarjouksesi on nyt tallennettu</h1>
                    <a href="luo-pyynto.php"><input type="button" value="Tarjoa toinen kyyti" /></a>
                    <a href="kyytipyynnot.php"><input type="button" value="Etsi matkustajia" /></a>
				</div>
            </section>
